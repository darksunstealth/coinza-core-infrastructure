...
export default class KafkaService {
  constructor(brokers, clientId, options = {}) {
    this.clientId = clientId; // Armazena o clientId para uso posterior
  ...
  async initialize() {
    try {
      ...
      console.info(`Kafka Producer (${this.clientId}) conectado com sucesso.`);
    } catch (error) {
      console.error(`Erro ao conectar Kafka Producer (${this.clientId}):`, error);
      throw error;
    }
  }
